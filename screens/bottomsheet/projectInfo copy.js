...
function InfoPage() {
    ...
    <View style={[styles.container, ]} >
      ...
      <View style={{alignItems:'center' }} >
        ...
        <FontAwesome name="group"  size={60} color={theme['color-primary-500']} />         
            ...
            <Text category='c2' appearance='hint' style={{marginTop:15}}>Learn about the type of projects we support.{"\n"}</Text>
                ...
                <View >
                    <Text category='h4' style={{marginTop:10, marginBottom:10, color: theme["color-success-300"]}}>The stronger we grow, the more we impact. </Text>
                ...
                <View style={{marginTop:25, marginBottom:15}}>
                    <Text category='h4' style={{marginBottom:10, color: theme["color-success-300"]}}>Who are we working with to protect the planet?</Text>
                    <Text category='h6'><FontAwesome name="tree" size={24} color={theme['color-primary-500']} />  Reforestation Projects {"\n"} </Text>
                    ...
                    <Text category='h6'><SimpleLineIcons name="energy" size={24} color={theme['color-primary-500']}/>  Renewable Energy Projects{"\n"}</Text>
                    ...
                    <Text category='h6'><FontAwesome5 name="wine-bottle" size={24} color={theme['color-primary-500']}/>  Waste Reduction Projects{"\n"}</Text>
                    ...
                    <Text category='h6'><FontAwesome5 name="fish" size={24}  color={theme['color-primary-500']} />  Wildlife Conservation Projects {"\n"}</Text>
                    ...
                    <Text category='h6'><MaterialCommunityIcons name="corn" size={24}  color={theme['color-primary-500']} />  Sustainable Agriculture Projects: {"\n"}</Text>
